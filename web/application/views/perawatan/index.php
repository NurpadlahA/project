        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    class="btn btn-danger btn-sm active" onclick="return hapusperawatan('Anda yakin ingin menghapus perawatan mobil <?php echo $rwt->tanggal?> ? ')" >Hapus</a>
                </td>
            </tr>
